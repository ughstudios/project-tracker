...
export default async function CalibrationFormPage() {
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-4">
      ...
      <div className="panel-surface rounded-xl p-6">
        <div className="mb-5 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-semibold">{t("publicForms.pages.calibration.title")}</h1>
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
              {t("publicForms.pages.calibration.subtitle")}
            </p>
          </div>
          <Link
            href="/forms"
          ...
          >
            {t("publicForms.pages.calibration.back")}
          </Link>
        </div>
