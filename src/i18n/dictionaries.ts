...
const en: MessageTree = {
  ...
  tools: {
    ...
    depthFieldHint: "First number = bits per color (R, G, B each). Second = bits for one full pixel.",
    depthOptionFmt: "{bpc} ({bpp} bpp)",
...
const zh: MessageTree = {
  ...
  tools: {
    ...
    labelFps: "帧率（Hz）",
    labelColorDepth: "色深",
    depthFieldHint: "选项里：前面的数字是红/绿/蓝各多少位；括号内是一整个像素的总位数（bpp）。",
    depthOptionFmt: "{bpc}（{bpp} bpp）",
