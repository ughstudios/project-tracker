...
const en: MessageTree = {
  ...
  tools: {
    ...
    projectPlanner: {
      ...
      inputSourcesLead: "Add each connector type and how many you need. This does not run signal math yet—it is a record for board layout (e.g. how many HDMI vs SDI feed the controller).",
...
const zh: MessageTree = {
  ...
  tools: {
    ...
    projectPlanner: {
      ...
      inputSourcesLead:
        "按连接器类型与数量添加行，便于对照机箱输入板配置（尚未参与带宽运算）。",
      inputType: "接口类型",
      inputCount: "数量",
      inputAdd: "添加一行",
      inputRemove: "删除",
