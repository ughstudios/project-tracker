...
const en: MessageTree = {
  ...
  tools: {
    ...
    streamTitle: "Stream bandwidth",
    streamHelp:
      "See whether one idealized ~1G or ~5G link can carry your stream. Enter a width and height, or a total pixel count — not both at once (width × height wins if both numbers are set).",
    streamPixelBlockTitle: "Pixels per frame",
    streamResolutionTitle: "Option A — width × height",
    streamResolutionHint: "When both width and height are greater than zero, we use their product and ignore the total-pixel field below.",
    streamOrDivider: "or",
    streamTotalTitle: "Option B — total pixel count",
    labelTotalPixels: "Total pixels",
    streamTotalHint: "Use this when you already know the pixel total. Leave width and height empty (or clear them).",
    streamTotalDisabledHint: "Width and height are set, so the total field is ignored. Clear width or height to edit total pixels.",
    streamActiveFromResolution: "Using {w} × {h} = {pixels} pixels per frame.",
    streamActiveFromTotal: "Using your total: {pixels} pixels per frame.",
    labelWidth: "Width (px)",
    labelHeight: "Height (px)",
    labelFps: "Frame rate (Hz)",
    ...
    portFitHeading: "Single port (ideal link)",
    port1gBadge: "~1G",
    port5gBadge: "~5G",
    portFitOk: "OK",
    portFitOver: "Over limit",
    outStreamMbps: "Stream bandwidth (Mbps)",
    outUtil1g: "Share of ~{mbps} Mbps (1G preset)",
    outUtil5g: "Share of ~{mbps} Mbps (5G preset)",
...
const zh: MessageTree = {
  ...
  tools: {
    ...
    streamTitle: "码流带宽",
    streamHelp:
      "估算单条理想化类 1G 或类 5G 链路能否承载。可填「宽 × 高」，或只填「总像素」——二者不要同时生效：只要宽和高都大于 0，就以乘积为准并忽略总像素。",
    streamPixelBlockTitle: "每帧像素数",
    streamResolutionTitle: "方式一：宽 × 高",
    streamResolutionHint: "宽、高均大于 0 时，使用二者乘积，下方「总像素」输入会被忽略。",
    streamOrDivider: "或",
    streamTotalTitle: "方式二：总像素数",
    labelTotalPixels: "总像素数",
    streamTotalHint: "已知总像素时使用；宽、高请留空或清零。",
    streamTotalDisabledHint: "已填写宽高，总像素输入无效。若要改总像素，请先清空宽或高。",
    streamActiveFromResolution: "当前按 {w} × {h} = 每帧 {pixels} 像素。",
    streamActiveFromTotal: "当前按您填写的总像素：每帧 {pixels} 像素。",
    labelWidth: "宽度（像素）",
    labelHeight: "高度（像素）",
    labelFps: "帧率（Hz）",
    labelColorDepth: "色深",
    ...
    portFitHeading: "单口（理想链路）",
    port1gBadge: "~1G",
    port5gBadge: "~5G",
    portFitOk: "可行",
    portFitOver: "超限",
    outStreamMbps: "码流带宽（Mbps）",
    outUtil1g: "占 ~{mbps} Mbps（1G 预设）比例",
    outUtil5g: "占 ~{mbps} Mbps（5G 预设）比例",
    onePortTitle: "单口能否承载？",
    onePortSubtitle:
