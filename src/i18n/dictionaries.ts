...
const en: MessageTree = {
  ...
  tools: {
    ...
    refTitle: "Max pixels (reference grid)",
    refSubtitle:
      "Floor of max pixels = usable Mbps × 1e6 ÷ (fps × bits per pixel). Presets: 1G ≈ 940 Mbps, 5G ≈ 4700 Mbps.",
    colPerColor: "Per color (bits)",
    colBitsPerPixel: "Bits per pixel",
    colFps: "FPS",
    colMax1g: "Max pixels @ ~940 Mbps",
    colMax5g: "Max pixels @ ~4700 Mbps",
    ...
    capacityTitle: "Max pixels for a link",
    capacityHelp: "Pick link speed, frame rate, and color depth (same choices as above).",
    preset1g: "Use ~940 Mbps (1G-class)",
    preset5g: "Use ~4700 Mbps (5G-class)",
...
const zh: MessageTree = {
  ...
  tools: {
    ...
    refTitle: "最大像素数（参考表）",
    refSubtitle: "最大像素取下整：可用 Mbps × 1e6 ÷ (帧率 × 每像素位数)。预设：1G ≈ 940 Mbps，5G ≈ 4700 Mbps。",
    colPerColor: "单色（位）",
    colBitsPerPixel: "每像素位数",
    colFps: "帧率",
    colMax1g: "最大像素（~940 Mbps）",
    colMax5g: "最大像素（~4700 Mbps）",
    streamTitle: "码流带宽",
    streamHelp:
    ...
    capacityTitle: "链路可承载的最大像素",
    capacityHelp: "选择链路速度、帧率与色深（与上方选项一致）。",
    preset1g: "使用 ~940 Mbps（类 1G）",
    preset5g: "使用 ~4700 Mbps（类 5G）",
