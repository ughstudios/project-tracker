...
const en: MessageTree = {
  ...
  tools: {
    title: "Tools",
    subtitle: "LED pixel-stream calculators for 1G / 5G-style links (idealized uncompressed math).",
    ...
    disclaimerBullet2: "“8-bit” here means eight bits total per pixel (e.g. grayscale). RGB888 is 24 bits per pixel.",
    ...
    refSubtitle: "Floor of max pixels = usable Mbps × 1e6 ÷ (fps × bits per pixel). Presets: 1G ≈ 940 Mbps, 5G ≈ 4700 Mbps.",
    colBpp: "Bits / pixel",
    colFps: "FPS",
    ...
    labelBpp: "Depth",
    streamPixelsNote: "Example: 720,000 px @ 60 Hz × 24 bpp ≈ 1,037 Mbps — above a ~940 Mbps 1G-class link; 16 bpp or 8 bpp fits with headroom.",
    bppOption: {
      "8": "8 (e.g. grayscale, 8 bpp total)",
      "16": "16 (e.g. RGB565)",
      "24": "24 (RGB888)",
    },
    ...
    capacityHelp: "Pick a usable throughput (presets or your own number), frame rate, and bits per pixel.",
...
const zh: MessageTree = {
  ...
  tools: {
    title: "工具",
    subtitle: "面向类 1G / 5G 链路的 LED 像素流估算（理想化、未压缩比特流）。",
    ...
    disclaimerBullet2: "此处的「8 位」指每像素总共 8 位（如灰度）。RGB888 为每像素 24 位。",
    ...
    labelFps: "帧率（Hz）",
    labelBpp: "色深",
    streamPixelsNote: "示例：720,000 像素 @ 60 Hz × 24 bpp ≈ 1,037 Mbps，高于约 940 Mbps 的类 1G 链路；16 bpp 或 8 bpp 则有余量。",
    bppOption: {
      "8": "8（如灰度，每像素共 8 位）",
      "16": "16（如 RGB565）",
      "24": "24（RGB888）",
    ...
    capacityHelp: "选择可用吞吐（预设或自定义）、帧率与每像素位数。",
