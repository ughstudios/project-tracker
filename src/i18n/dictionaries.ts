...
const en: MessageTree = {
  ...
  tools: {
    ...
    edid: {
      ...
      subtitle:
        "Upload the actual EDID from the display, processor, or HDMI sink. This is the more accurate check because it uses real timing descriptors and HDMI capability blocks instead of a generic overhead estimate.",
      ...
      targetHelp: "Enter the resolution, refresh rate, and RGB color depth you want to validate against the uploaded EDID.",
...
const zh: MessageTree = {
  ...
  tools: {
    ...
    edid: {
      title: "基于 EDID 的 HDMI 精确校验",
      subtitle:
        "上传显示屏、处理器或 HDMI 接收端的实际 EDID。它会使用真实时序描述符与 HDMI 能力块，比通用开销估算更准确。",
      uploadTitle: "上传 EDID",
      ...
      targetHelp: "输入要校验的分辨率、刷新率和 RGB 色深。",
