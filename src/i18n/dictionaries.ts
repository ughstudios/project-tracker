...
const en: MessageTree = {
  ...
  projects: {
    ...
    listToolbarHint: "Filter by customer and search across name, product, customer, and manager.",
    ...
    couldNotAssignManager: "Could not assign project manager.",
  ...
  customerContacts: {
    contacts: "Contacts",
    addSection: "Add customer contact",
    addSectionHelp: "Add a person and assign them to a customer company.",
    detailTitle: "Customer contacts",
    detailHelp: "Store names, phone numbers, email addresses, titles, and notes for people at this company.",
    namePlaceholder: "Contact name",
    emailPlaceholder: "name@example.com",
    phone: "Phone",
    phonePlaceholder: "+1 555 0100",
    titleLabel: "Title / role",
    titlePlaceholder: "Purchasing, PM, site contact…",
    notes: "Notes",
    notesPlaceholder: "Preferred language, best time to call, relationship notes…",
    addContact: "Add contact",
    adding: "Adding…",
    savedContacts: "Saved contacts ({count})",
    none: "No contacts saved yet.",
    noDirectContact: "No email or phone saved.",
    edit: "Edit",
    deleting: "Deleting…",
    deleteConfirm: 'Delete contact "{name}"?',
    couldNotCreate: "Could not add contact.",
    couldNotSave: "Could not save contact.",
    couldNotDelete: "Could not delete contact.",
    viewFor: "View contacts for {name}",
  },
  adminRoles: {
    title: "Admin roles",
    subtitle:
  ...
  tools: {
    ...
    displayIo: {
      ...
      edidCalloutTitle: "Need an accurate HDMI answer? Use the EDID check.",
      edidCalloutBody:
        "This page is only a quick estimate. For real compatibility work, upload the actual EDID file in the EDID check tab. That tool reads the sink's real timings, blanking, front porch, sync width, back porch, max TMDS / FRL limits, pixel clock, and bandwidth instead of using this fixed 1.2x overhead.",
    ...
    edid: {
      title: "EDID-based HDMI accuracy check",
      subtitle:
        "Upload the actual EDID from the display, processor, or sink. This is the more accurate check because it uses real timing descriptors instead of a generic overhead estimate.",
      uploadTitle: "Upload EDID",
      uploadHelp: "Accepts binary EDID dumps or text files containing hex bytes.",
      fileLabel: "EDID file",
      fileLoaded: "Loaded: {name}",
      readFailed: "Could not read that EDID file.",
      targetTitle: "Target format to compare",
      targetHelp: "Choose HDMI or DisplayPort generation, then enter the resolution, refresh rate, and RGB color depth to validate against the uploaded EDID.",
      interfaceCeilingHint: "Reference ceiling for selected interface: ~{gbps} Gbit/s.",
      resultTitle: "EDID compatibility result",
      noEdid: "Upload an EDID file to calculate real timing and HDMI limits.",
      checksumOk: "EDID checksum OK",
      checksumBad: "EDID checksum failed",
      matchOk: "Target mode found in EDID",
      matchNo: "Target mode not found in EDID",
      interfaceCompare: "Selected interface payload {need} / {max} Gbit/s",
      interfaceUnknown: "Select a mode to compare against interface ceiling",
      tmdsCompare: "TMDS clock {need} / {max} MHz",
      tmdsUnknown: "TMDS max not declared",
      linkCompare: "HDMI line rate {need} / {max} Gbit/s",
      linkUnknown: "HDMI bandwidth max not declared",
      metricSink: "Sink",
      metricSinkNote: "EDID {version} · {blocks} block(s) parsed.",
      metricParsedModes: "Parsed modes",
      metricParsedModesNote: "{extensions} extension block(s) declared.",
      metricMaxPixelClock: "Max pixel clock",
      metricMaxPixelClockDeclared: "Declared by HDMI capability block.",
      metricMaxPixelClockParsed: "Highest parsed timing because no HDMI max was declared.",
      metricMaxBandwidth: "Max HDMI bandwidth",
      metricMaxBandwidthNote: "No HDMI VSDB / HDMI Forum bandwidth limit was found.",
      matchedTimingTitle: "Matched EDID timing",
      matchedTimingSummary: "{mode} from {source}.",
      pixelClock: "Pixel clock",
      pixelClockNote: "Taken directly from the matched timing descriptor or CTA mode.",
      payloadBandwidth: "RGB payload",
      payloadBandwidthNote: "Pixel clock x selected RGB bits per pixel, including blanking cadence.",
      tmdsBandwidth: "HDMI TMDS line rate",
      tmdsBandwidthNote: "Estimated encoded HDMI rate for the selected RGB depth.",
      noExactMode:
        "The uploaded EDID does not advertise that exact resolution and refresh rate. Check the mode table below for the timings the sink actually declares.",
      modesTitle: "Advertised timings",
      modesHelp: "Shows detailed timings first when available, including blanking, front porch, sync width, back porch, total pixels / lines, and source.",
      tableMode: "Mode",
      tableClock: "Pixel clock",
      tableHorizontal: "Horizontal timing",
    ...
    projectPlanner: {
      ...
      outputType: "Output link",
      outputAdd: "Add output row",
      outputSummary: "Planned output ports (your rows): {total}. {list}",
      outputSummaryEmpty: "No outputs listed.",
      outputBandwidthHint: "Minimum ports from bandwidth at the chosen tier: about {required} (compare to your planned runs).",
      outputIf: {
        ethernet_1g_rj45: "1G Ethernet (RJ45)",
        ethernet_5g_rj45: "5G Ethernet (RJ45)",
        fiber_10g: "10G fiber",
      },
      ...
      inputRemove: "Remove",
      inputSummary: "Total input connectors: {total}. {list}",
      inputSummaryEmpty: "No inputs listed.",
      inputIf: {
        hdmi20: "HDMI 2.0",
        hdmi21: "HDMI 2.1",
        dp12: "DisplayPort 1.2",
        dp14: "DisplayPort 1.4",
        sdi3g: "3G-SDI",
        sdi6g: "6G-SDI",
        sdi12g: "12G-SDI",
        threeInOne: "3-in-1 (HDMI 2.1 + DP 1.4 + 12G-SDI)",
        st2110: "ST 2110 (IP)",
      },
      issueTitle: "Check these before you rely on this pairing",
      issue: {
        linkSet:
          "This processor has no output that matches the selected receiver link set (1G vs 5G). Change the link set or pick a different processor.",
        outputShortfall:
          "This processor cannot cover the screen with the published port count and/or pixel load for the selected link set (even if resolution and color depth are in range).",
        processorWidth: "Canvas width exceeds this processor’s published maximum width.",
        processorHeight: "Canvas height exceeds this processor’s published maximum height.",
        processorFps: "Refresh rate is higher than this processor’s published maximum frame rate.",
        processorDepth: "Color depth is higher than this processor’s published maximum (bit per channel).",
        receiverDepth: "Color depth is higher than this receiving card’s published maximum.",
        receiverFps: "Refresh rate is higher than this receiving card’s published maximum frame rate.",
        requirementReceiver: "Receiver card: “{name}” is not supported for this model.",
        requirementProcessor: "Processor: “{name}” is not supported for this model.",
      },
      pairingOk: "Processor and receiving card both meet the published signal limits for the numbers you entered (verify with the final BOM and field wiring).",
      noCardsForLinkSet: "No receiving cards in this project’s catalog match the selected link set. Change 1G/5G or extend the card list.",
      ...
      reviewReason: "This pairing is close, but at least one capability or feature requirement should be checked before quoting it.",
      guideWhy: "Why it works",
      guideInstall: "Install count",
      guideSignal: "Signal plan",
      guideVerify: "Before quoting",
      outputCapacityLine: "{output}: needs {required} ports, has {available}, and supports {capacity} pixels.",
      cardsInstallLine: "Plan {cards} receiver cards: {perCabinet} per cabinet, with {minimum} as the pixel-only minimum.",
      ...
      tableFit: "Fit",
      outputBreakdown: "{required} ports needed · {available} available · {capacity} px capacity",
      fitExact: "Exact match",
      fitReview: "Review specs",
      fitNoOutput: "Output shortfall",
    },
  },
  inventory: {
...
const zh: MessageTree = {
  ...
  projects: {
    ...
    createProject: "创建项目",
    listTitle: "项目列表",
    listToolbarHint: "按客户筛选，并可按名称、产品、客户名、项目经理搜索。",
    filterByCustomer: "客户",
    allCustomers: "全部客户",
    searchPh: "搜索项目…",
    noneFound: "未找到项目。",
    ...
    couldNotAssignManager: "无法分配项目经理。",
  ...
  customerContacts: {
    contacts: "联系人",
    addSection: "添加客户联系人",
    addSectionHelp: "填写联系人信息，并分配到对应客户公司。",
    detailTitle: "客户联系人",
    detailHelp: "保存该公司的联系人姓名、电话、邮箱、职位与备注。",
    namePlaceholder: "联系人姓名",
    emailPlaceholder: "name@example.com",
    phone: "电话",
    phonePlaceholder: "+1 555 0100",
    titleLabel: "职位 / 角色",
    titlePlaceholder: "采购、项目经理、现场联系人…",
    notes: "备注",
    notesPlaceholder: "首选语言、适合联系时间、关系备注…",
    addContact: "添加联系人",
    adding: "添加中…",
    savedContacts: "已保存联系人（{count}）",
    none: "暂无联系人。",
    noDirectContact: "尚未填写邮箱或电话。",
    edit: "编辑",
    deleting: "删除中…",
    deleteConfirm: "删除联系人「{name}」？",
    couldNotCreate: "无法添加联系人。",
    couldNotSave: "无法保存联系人。",
    couldNotDelete: "无法删除联系人。",
    viewFor: "查看「{name}」的联系人",
  },
  adminRoles: {
    title: "管理员角色",
    subtitle:
  ...
  tools: {
    ...
    displayIo: {
      ...
      edidCalloutTitle: "需要准确 HDMI 结论？请使用 EDID 校验。",
      edidCalloutBody:
        "本页只是快速估算。真正做兼容性判断时，请在 EDID 校验标签上传实际 EDID 文件。该工具会读取接收端真实时序、消隐、前肩、同步宽度、后肩、TMDS / FRL 上限、像素时钟和带宽，而不是使用这里固定的 1.2 倍开销。",
      formTitle: "输入格式",
    ...
    edid: {
      title: "基于 EDID 的接口精确校验",
      subtitle:
        "上传显示屏、处理器或接收端的实际 EDID。它会使用真实时序描述符，比通用开销估算更准确。",
      uploadTitle: "上传 EDID",
      uploadHelp: "支持二进制 EDID dump，或包含十六进制字节的文本文件。",
      fileLabel: "EDID 文件",
      fileLoaded: "已加载：{name}",
      readFailed: "无法读取该 EDID 文件。",
      targetTitle: "要比较的目标格式",
      targetHelp: "先选择 HDMI 或 DisplayPort 代际，再输入要校验的分辨率、刷新率和 RGB 色深。",
      interfaceCeilingHint: "所选接口参考上限：约 {gbps} Gbit/s。",
      resultTitle: "EDID 兼容性结果",
      noEdid: "上传 EDID 文件后可计算真实时序与 HDMI 上限。",
      checksumOk: "EDID 校验和正常",
      checksumBad: "EDID 校验和失败",
      matchOk: "EDID 中找到目标模式",
      matchNo: "EDID 中未找到目标模式",
      interfaceCompare: "所选接口载荷 {need} / {max} Gbit/s",
      interfaceUnknown: "匹配到时序后才可与接口上限比较",
      tmdsCompare: "TMDS 时钟 {need} / {max} MHz",
      tmdsUnknown: "未声明 TMDS 上限",
      linkCompare: "HDMI 线速 {need} / {max} Gbit/s",
      linkUnknown: "未声明 HDMI 带宽上限",
      metricSink: "接收端",
      metricSinkNote: "EDID {version} · 已解析 {blocks} 个区块。",
      metricParsedModes: "已解析模式",
      metricParsedModesNote: "声明 {extensions} 个扩展区块。",
      metricMaxPixelClock: "最大像素时钟",
      metricMaxPixelClockDeclared: "来自 HDMI 能力块声明。",
      metricMaxPixelClockParsed: "未声明 HDMI 上限，显示已解析时序中的最高值。",
      metricMaxBandwidth: "最大 HDMI 带宽",
      metricMaxBandwidthNote: "未找到 HDMI VSDB / HDMI Forum 带宽上限。",
      matchedTimingTitle: "匹配到的 EDID 时序",
      matchedTimingSummary: "{mode}，来源：{source}。",
      pixelClock: "像素时钟",
      pixelClockNote: "直接来自匹配的时序描述符或 CTA 模式。",
      payloadBandwidth: "RGB 载荷",
      payloadBandwidthNote: "像素时钟 x 所选 RGB 每像素位数，按真实时序节奏计算。",
      tmdsBandwidth: "HDMI TMDS 线速",
      tmdsBandwidthNote: "按所选 RGB 色深估算的 HDMI 编码后线速。",
      noExactMode: "上传的 EDID 没有声明这个精确分辨率和刷新率。请查看下方表格中的实际声明时序。",
      modesTitle: "已声明时序",
      modesHelp: "优先显示详细时序，包含消隐、前肩、同步宽度、后肩、总像素/总行数与来源。",
      tableMode: "模式",
      tableClock: "像素时钟",
      tableHorizontal: "水平时序",
      tableVertical: "垂直时序",
      tableSource: "来源",
    },
    projectPlanner: {
      ...
      outputType: "输出链路",
      outputAdd: "添加一行输出",
      outputSummary: "规划输出端口（各行合计）：{total}。{list}",
      outputSummaryEmpty: "未填写输出。",
      outputBandwidthHint: "当前链路档位下带宽至少需要约 {required} 个端口（可与上方规划路数对照）。",
      outputIf: {
        ethernet_1g_rj45: "1G 网线（RJ45）",
        ethernet_5g_rj45: "5G 网线（RJ45）",
        fiber_10g: "10G 光纤",
      },
      cabinetPixels: "单箱像素",
      ...
      inputAdd: "添加一行",
      inputRemove: "删除",
      inputSummary: "输入接口合计：{total}。{list}",
      inputSummaryEmpty: "未填写输入。",
      inputIf: {
        hdmi20: "HDMI 2.0",
        hdmi21: "HDMI 2.1",
        dp12: "DisplayPort 1.2",
        ...
        sdi6g: "6G-SDI",
        sdi12g: "12G-SDI",
        threeInOne: "三合一（HDMI 2.1 + DP 1.4 + 12G-SDI）",
        st2110: "ST 2110（IP）",
      },
      issueTitle: "选用前请确认以下问题",
      issue: {
        linkSet: "该处理器在目录中没有与当前接收链路组（1G / 5G）匹配的输出类型，请更换链路组或更换处理器。",
        outputShortfall:
          "在该链路组下，按已公布的网口数量与带载仍无法满足当前屏体（即便分辨率与色深在单指标内达标）。",
        processorWidth: "画面宽度超过该处理器公布的单屏最大宽度。",
        processorHeight: "画面高度超过该处理器公布的单屏最大高度。",
        processorFps: "刷新率超过该处理器公布的最高帧率。",
        processorDepth: "色深（每通道 bit）超过该处理器公布的规格。",
        receiverDepth: "色深超过该接收卡公布的规格。",
        receiverFps: "刷新率超过该接收卡公布的最高帧率。",
        requirementReceiver: "接收卡：不支持所需的「{name}」能力（按规格表对照）。",
        requirementProcessor: "处理器：不支持所需的「{name}」能力（按规格表对照）。",
      },
      ...
      tableOutput: "处理器输出",
      tableFit: "匹配",
      outputBreakdown: "需 {required} 个网口 · 可用 {available} 个 · 带载 {capacity} 像素",
      fitExact: "完全匹配",
      fitReview: "需复核",
      fitNoOutput: "输出不足",
    },
