...
const en: MessageTree = {
  ...
  aiAssistant: {
    title: "AI assistant",
    subtitle:
      "Ask questions about issues, projects, customers, inventory, and (if you have access) work records and audit logs. Answers use a live snapshot of data you are allowed to see.",
    disclaimer:
      "Replies are generated by a language model and may be incomplete. They are not a substitute for checking the underlying pages or exports.",
    emptyHint: "Ask a question below. The assistant only uses data from your current access level.",
    roleUser: "You",
    roleAssistant: "Assistant",
    inputLabel: "Message",
    inputPlaceholder: "e.g. Which issues mention receiver cards?",
    send: "Send",
    sending: "Sending…",
    stop: "Stop",
...
const zh: MessageTree = {
  ...
  aiAssistant: {
    title: "AI 助手",
    subtitle:
      "可就问题、项目、客户、库存以及（若有权限）工作记录与审计日志提问。回答仅基于您当前权限下的实时数据摘要。",
    disclaimer: "回答由语言模型生成，可能不完整，不能替代在对应页面或导出中核对原始信息。",
    emptyHint: "在下方输入问题。助手只会使用您有权查看的数据。",
    roleUser: "您",
    roleAssistant: "助手",
    inputLabel: "消息",
    inputPlaceholder: "例如：哪些问题里提到了接收卡？",
    send: "发送",
    sending: "发送中…",
    stop: "停止",
    genericError: "出错了。",
