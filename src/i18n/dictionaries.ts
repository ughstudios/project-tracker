...
const en: MessageTree = {
  ...
  tools: {
    ...
    projectSuggestor: {
      ...
      labelOutputPreference: "Output preference",
      outputAuto: "Auto-match receiver link",
      ...
      recommendationsTitle: "Processor + receiver-card recommendations",
      recommendationsSubtitle: "The top packages meet the signal, output, feature, and capacity requirements.",
      noExactRecommendations: "No exact package satisfies every requirement; the table shows the closest review candidates.",
